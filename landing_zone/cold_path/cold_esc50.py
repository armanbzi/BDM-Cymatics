...
2. Picks one record per random category to ensure variety across categories.
3. Generates cymatics image + video, stores structured artifacts in MinIO,
   and appends rows to the shared ``metadata/observations.csv``.
...
# Column order — shared with warm/hot/cold-freesound
...
# =============================================================================
#  Cymatics settings (identical to warm / hot / cold-freesound)
# =============================================================================
SAMPLE_RATE = 44100
FPS = 30
VIDEO_RES = 600
...
# =============================================================================
#  Cymatics helpers (same as warm/hot/cold-freesound)
# =============================================================================
def build_zones(gs):
...
# =============================================================================
#  Audio-feature helpers (identical to warm / hot / cold-freesound)
# =============================================================================
...
# =============================================================================
#  Process one ESC-50 record — cymatics + upload + metadata row
# =============================================================================
def process_record(client, audio_np, esc_row):
    """Generate cymatics, upload artifacts, return metadata row dict (or None)."""
    ...
    # Spectral features (on full original audio, normalised)
    ...
    image_key = f"images/{SOURCE}/{peak_freq_int}/{stem}.png"
    video_key = f"videos/{SOURCE}/{peak_freq_int}/{stem}.mp4"
...
def run(batch_size=10):
    ...
    # Read ESC-50 metadata and filter to our categories
